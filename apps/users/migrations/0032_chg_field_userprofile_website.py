...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('profile', 'website', self.gf('apps.users.fields.MultiURLField')())


    def backwards(self, orm):

        # Changing field 'UserProfile.website'
        db.alter_column('profile', 'website', self.gf('django.db.models.fields.URLField')(max_length=200))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 22, 12, 13, 43, 313378)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 22, 12, 13, 43, 313215)'}),
        ...
        'users.userprofile': {
            ...
            'website': ('apps.users.fields.MultiURLField', [], {'default': "''", 'blank': 'True'})
        }
    }
